public class Main
{
	public static void main(String[] args) {
		Proprietario prop1 = new Proprietario("11111", "Matheus Aguiar");
		Proprietario prop2 = new Proprietario("22222", "Sara Lima");
		Proprietario prop3 = new Proprietario("33333", "Augusto Cesar");
		
		Veiculo v1 = new Veiculo(prop1);
		v1.setPlaca("ABC-0101");
		v1.setModelo("Uno");
		Veiculo v2 = new Veiculo(prop1);
		v2.setPlaca("DEF-0202");
		v2.setModelo("Palio");
		Veiculo v3 = new Veiculo(prop3);
		v3.setPlaca("GHI-0404");
		v3.setModelo("Fusca 96");
		Veiculo v4 = new Veiculo(prop2);
		v4.setPlaca("JKL-0606");
		v4.setModelo("Moto");
